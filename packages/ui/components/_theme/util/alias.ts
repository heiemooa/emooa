...
export default function formatToken(derivativeToken: RawMergedToken): AliasToken {
  ...
  const aliasToken: AliasToken = merge(
    {},
    mergedToken,
    {
      // ============== Background ============== //
      ...
      colorErrorOutline: getAlphaColor(mergedToken.colorErrors.colorErrorBg, mergedToken.colorBgContainer),
      colorWarningOutline: getAlphaColor(mergedToken.colorWarnings.colorWarningBg, mergedToken.colorBgContainer),
