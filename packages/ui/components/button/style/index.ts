...
const prepareComponentToken: GetDefaultToken<'Button'> = token => {
  return {
    ...
    primaryDisabledColor: token.colorWhiteSecondary,
    ...
    primarySuccessDisabledColor: token.colorWhiteSecondary,
    ...
    primaryDangerDisabledColor: token.colorWhiteSecondary,
    ...
    primaryWarningDisabledColor: token.colorWhiteSecondary,
