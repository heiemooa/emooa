...
import ResponsiveObserve, { Breakpoint, responsiveArray, ScreenMap } from './utils/responsiveObserve';
...
function Row(baseProps: RowProps, ref) {
  ...
  const { className, style, children, align, justify, gutter, ...rest } = props;
